...
| Layout Consistency | Layout(p, layout) | Align(p, layout.align) && Allocated(p, layout.size, any) | [GlobalAlloc::realloc](https://doc.rust-lang.org/nightly/std/alloc/trait.GlobalAlloc.html#method.realloc) | precond |
