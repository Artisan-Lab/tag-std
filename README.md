...
With the static linter [safety-tool](safety-tool) and [annotation usage](usage.md) under development, we are also exploring the application of this approach to Rust projects beyond the standard library, including [Rust-for-Linux](https://github.com/rust-for-linux) and [Asterinas](https://github.com/asterinas/asterinas). You can find all of our contributions and fixes in [track-record](https://github.com/safer-rust/track-record).
